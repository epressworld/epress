...
/**
 * ChakraProvider - Chakra UI Provider 组件
 *
 * 为应用提供 Chakra UI 主题和样式系统
 *
 * @param {Object} props
 ...
 * </ChakraProvider>
 */
export function ChakraProvider({ defaultTheme, ...props }) {
  return (
...
function ColorModeProvider({ defaultTheme, ...props }) {
  return (
    <ThemeProvider
      attribute="class"
