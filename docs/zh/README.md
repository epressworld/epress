...
我也曾尝试过像Mastodon和Bluesky这样的联邦式社交网络。它们确实比传统中心化平台进了一步，但这并没有从根本上解决问题。我们只是从信任一个“大中心”（如 Twitter），变成了信任一个“小中心”（联邦实例的管理员）。这个“小中心”不仅掌握着审查和关停的权力，其不菲的运营成本也使其最终会面临商业化压力，让我们重新陷入与中心化平台类似的困境。我们的数据和身份，本质上依然托管于他人之手。我们依然是“数字租客”，而非“数字房主”，这距离真正的数据主权还有最关键的一步。
