...
在 epress 网络中，一旦用户通过签名发布内容，携带来源证明（PoS）的内容单元将被关注者节点同步并复制，每个节点都在本地存储一份带有 PoS 的副本。这意味着内容一旦被签名发布，理论上就无法被彻底销毁。这是否意味着用户必须对其签名的内容承担永久责任？

要回答这个问题，我们必须回到 PoS 的根本定义。PoS 作为来源证明，其核心目的是在节点间的信息传输过程中确认身份的真实性。用户的签名行为仅限于验证内容的来源、完整性和时间戳，从而确保接收方能够追溯“谁在何时发布了什么”。责任的边界严格限于来源真实性：用户不能否认在特定时间发布了特定内容，但这并不延伸至内容本身的实质性义务或法律后果。

这与现实世界中的合同责任形成鲜明对比。合同通常涉及多方，规定权利和义务，并使用签名来确认各方的共识。在签署 PoS 的过程中，不存在第二方或第三方，因此无需定义义务主体或权力关系。PoS 本质上是信息在网络中流通的单方身份凭证，在设计上不涉及对内容本身的责任，除非内容本身明确声明了此类义务。

#### 11.2.1 所有表达的时间性本质

每一种人类表达在本质上都受时间限制。一位科学家2010年发表的结论可能在2020年被新证据推翻。一个人25岁时真诚持有的政治观点，到40岁时可能已经发自内心地改变。这不是软弱或前后矛盾——这是一个思考着的心智与不断变化的世界进行对话时正常、健康的运作方式。

PoS 如实记录了这一现实。当用户签署一份内容时，签名所断言的是：“我，在这个特定的时刻，撰写并支持这份声明”。它所断言的不是：“我将永远持有这一观点”。PoS 中的时间戳不仅仅是一个技术字段——它是一个语义边界。被签名的声明在其时间语境下是真实的，网络精确地保存了这种受时间约束的真实性。

这意味着 epress 网络不是一个将用户永久锁定在过去立场上的陷阱。它是一个如实记录一个人思想如何演进的档案库。一个用户随时间累积的 PoS 记录链，不是负担——它可能是其最有价值的智识资产：一个主权心智与世界对话的可验证、高保真记录。

#### 11.2.2 更新、修正与撤回

处理观点变化的主要机制不是删除，而是迭代——这是设计上的选择，而非局限。

当用户的观点发生变化，甚至彻底推翻了之前发布的立场时，用户只需发布一个新的 PoS，来发布更新的内容、修正的声明或明确的撤回声明。**思想的演进本身就是网络的一等公民。** 一个后续发布的 PoS，声明“我不再持有 [contentHash] 所表达的观点”，不是承认失败——它是对智识记录的一次贡献，展示了知识上的诚实与成长。

这种迭代模型具有更深层的认识论价值。在中心化平台上，被删除的帖子不留任何痕迹，使得“我改变了想法”与“我在隐藏我曾经说过的话”之间无法区分。在 epress 上，一个人不断演进的观点的完整链条是透明且可验证的。这是更诚实的，而不是更少宽容的。

#### 11.2.3 本地发布的角色

“永久性”与“人性”之间所感知到的张力，通过第 6.1 节定义的蓄意设计的双状态发布模型，在架构层面就已经被很大程度上化解了，而不需要诉诸协议层面的解决方案。

- **本地发布**是草稿、探索性思考、情绪化表达，以及任何用户尚未准备好作为公开声明提交的内容的合适空间。它仅存在于用户自己的节点上，可以随时自由编辑或删除，不承担任何网络层面的承诺。
- **签名发布**是用户有意识地选择作为可验证、可引用的公共记录发布到网络上的内容。

签名这一行为，在设计上是一个蓄意设置的门槛。它应当被理解为等同于向公共档案馆提交手稿：这是一个有意识的行为，意味着“我准备好让这份内容成为公共记录的一部分了”。这种摩擦不是缺陷——它是一项特性，鼓励更有意图的公开表达。
...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| 1.1 | 2026年3月31日 | 扩展第11.2节，新增关于表达的时间性本质、迭代式更新以及本地发布角色等子章节 |
| 1.0 | 2025年9月24日 | 初始版本 |
